...
class ChangeDirectoryEvent : public BaseEvent
{
	...
	public :
		...
		ChangeDirectoryEvent(Application& app, string& ip, uint16_t port, int client_no, string& cwd);
		ChangeDirectoryEvent(Application& app, string& ip, uint16_t port, int client_no, char* buffer, int size);
